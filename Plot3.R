...
##      PLOT #3 PLot of Energy sub metering: plot3.png
plot.new()
dev.cur()
dev.copy (png, file ="./ExplAnalData/plot3.png")
# overpaling plots: http://cran.r-project.org/doc/contrib/Lemon-kickstart/kr_addat.html
